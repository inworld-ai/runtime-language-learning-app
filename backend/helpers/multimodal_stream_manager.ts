 ...
 * yields MultimodalContent, making it compatible with the 0.9 graph architecture.
 */
...
export class MultimodalStreamManager {
  ...
  pushAudio(chunk: AudioChunkInterface): void {
    ...
    // Note: GraphTypes.Audio requires number[] - conversion from Float32Array is unavoidable
    // due to SDK constraint. If chunk.data is already number[], we pass it directly.
